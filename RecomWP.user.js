...
// Polyfill for Wikipedia with no jQuery
  ...
  if (window.wgNamespaceNumber === 0 || window.wgPageName === 'Special:空白页面/RecomWP') {
    ...
    window.dailyFeatured = function (callback) {
